...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cdrtjgld9koi.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'nurayblog' # please enter your s3 bucket name
